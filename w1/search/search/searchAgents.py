...
class Corner_state:
    def __init__(self, pac_pos, eaten=None):
        self.pos = pac_pos
        self.eaten = (
            [False, False, False, False] if eaten is None else [i for i in eaten]
        )
...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState: pacman.GameState):
        ...
        self.start_state = Corner_state(self.startingPosition)
    ...
    def isGoalState(self, state: Corner_state):
        """
        ...
        for i in range(len(self.corners)):
            if self.corners[i] == state.pos:
                state.eaten[i] = True
        return False not in state.eaten
        # util.raiseNotDefined()

    def getSuccessors(self, state: Corner_state):
        """
        Returns successor states, the actions they require, and a cost of 1.
        ...
        for action in [
            ...
            if not hitsWall:
                next_state = Corner_state((x, y), state.eaten)
